      ...
      <ul className="team-members">
        <li className="team-member">
          ...
          <div className="team-member-info">
            <strong>Carina França</strong> I'm Brazilian living in Portugal, I'm
            28 years old, with a background in pharmacy, I'm changing careers to
            IT and really enjoying the process.
            <div>
              <br />
